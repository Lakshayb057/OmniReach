                  ...
                  <div className="space-y-6">
                    <div className="p-5 bg-[#070b14] border border-emerald-500/30 rounded-2xl space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-3 pt-2 text-xs">
                        ...
                        <div className="p-3 bg-[#0f172a] rounded-xl border border-slate-800">
                          <span className="text-slate-500 text-[10px] block">Deliverability Status</span>
                          <span className="font-semibold text-emerald-400 flex items-center gap-1">
                            <Zap size={13} /> Active & Ready
                          </span>
                        </div>
                      </div>
                        ...
                        {baileysSessionData?.qrCodeDataUrl ? (
                          <div className="space-y-4">
                            ...
                            <button
                              ...
                              className="px-4 py-2 bg-slate-800 hover:bg-slate-700 text-slate-200 rounded-xl text-xs font-bold flex items-center justify-center gap-2 mx-auto transition-all cursor-pointer"
                            >
                              <RefreshCw size={13} className={isStartingBaileys ? 'animate-spin' : ''} />
                              <span>{isStartingBaileys ? 'Refreshing QR Code...' : 'Refresh QR Code'}</span>
                            </button>
                          </div>
                        ) : (
                      ...
                      <div className="p-6 bg-[#070b14] border border-slate-800 rounded-2xl space-y-4">
                        ...
                        {pairingCodeResult && (
                          <div className="p-5 bg-gradient-to-r from-cyan-950/60 to-blue-950/60 border border-cyan-500/40 rounded-2xl text-center space-y-3 animate-fadeIn">
                            ...
                            <div className="text-3xl font-mono font-black text-white tracking-widest bg-[#070b14] py-3 px-6 rounded-xl border border-cyan-500/50 inline-block shadow-inner">
                              {pairingCodeResult}
                            </div>
                            ...
                            <p className="text-[11px] text-slate-300 max-w-sm mx-auto leading-relaxed">
                              On your phone: Open WhatsApp &gt; Linked Devices &gt; Link a Device &gt; Link with phone number instead &gt; Enter this code.
                            </p>
                          </div>
                        )}
                      </div>
